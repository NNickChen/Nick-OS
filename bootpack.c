			...
			if (256 <= i && i <= 511) { 
				...
				if (i == 256 + 0x0e) {	
					if (key_to == 0) {	
						if (cursor_x > 8) {
							...
							putfonts8_asc_sht(sht_win, cursor_x - 8, 28, COL8_000000, COL8_FFFFFF, " ", 1);
							cursor_x -= 8;
						}
					} else {	
				...
				if (i == 256 + 0x0f) { /* Tab */
					if (key_to == 0) {
						...
						cursor_c = -1;
						boxfill8(sht_win->buf, sht_win->bxsize, COL8_FFFFFF, cursor_x, 28, cursor_x + 1, 43);
